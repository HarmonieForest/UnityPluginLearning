...
namespace Opsive.UltimateCharacterController.Demo
{
    ...
    public class DemoManager : MonoBehaviour
    {
        ...
        [Tooltip("A reference to the character's prefab.")]
        ...
        {
            InitializeCharacter(Instantiate(m_CharacterPrefab), !m_FreeRoam, true);
        ...
        protected void InitializeCharacter(GameObject character, bool showZoneSelection, bool teleport)
        {
            ...
            var characterAnimator = character.GetComponent<ModelManager>().ActiveModel.GetComponent<Animator>();
        ...
        private void Update()
        {
            if (m_LastZoneIndex == -1) {
                ...
                if (Input.GetKeyDown(KeyCode.Escape) && !m_ZoneSelection.isActiveAndEnabled) {
        ...
        private bool ActivateDemoZone(DemoZone demoZone, bool teleport)
        {
            ...
            if (m_SelectPerspective) {
                m_SelectPerspective = false;
#if FIRST_PERSON_CONTROLLER && THIRD_PERSON_CONTROLLER
                SelectStartingPerspective(m_PerspectiveToggle.isOn, false);
