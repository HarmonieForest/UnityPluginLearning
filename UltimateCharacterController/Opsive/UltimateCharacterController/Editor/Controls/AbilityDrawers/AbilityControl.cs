                ...
                generateButton.clicked += () =>
                 {
                     ...
                     if (animatorControllers != null || firstPersonAnimatorControllers != null) {
                         var baseDirectory = EditorPrefs.GetString(c_EditorPrefsLastLastAnimatorCodePathKey, System.IO.Path.GetDirectoryName(AssetDatabase.GetAssetPath(MonoScript.FromScriptableObject(inspector))));
