        ...
        private class StateElementContainer : VisualElement
        {
            ...
            public StateElementContainer(IStateOwner stateOwner, ReorderableList reorderableList)
            {
                ...
                m_PersistButton.clicked += () =>
                {
                    ...
                    var bitwiseHash = new System.Version(preset.Data.Version).CompareTo(new System.Version("3.1")) >= 0;
                    ...
                    for (int i = 0; i < properties.Length; ++i) {
                        ...
                        if (valuePositionMap.ContainsKey(hash)) {
                            ...
                            if (!typeof(UnityEngine.Object).IsAssignableFrom(property.PropertyType)) {
                                ...
                                Serialization.GetUnityObjectIndexes(ref unityObjectIndexes, property.PropertyType, property.Name, 0, valuePositionMap, preset.Data.ValueHashes, preset.Data.ValuePositions,
                                                                    preset.Data.Values, false, MemberVisibility.Public, bitwiseHash);

                                Serialization.RemoveProperty(i, unityObjectIndexes, preset.Data, MemberVisibility.Public, bitwiseHash);
