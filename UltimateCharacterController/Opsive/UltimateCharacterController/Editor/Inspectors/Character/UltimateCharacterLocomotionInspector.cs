...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Character
{
    ...
    public class UltimateCharacterLocomotionInspector : CharacterLocomotionInspector
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            {
                if (m_MovementTypeReorderableList.SelectedIndex != -1) {
                    ShowMovementType(m_MovementTypeReorderableList.SelectedIndex);
                }
                if (m_AbilityReorderableList.SelectedIndex != -1) {
                    ShowAbility(true, m_AbilityReorderableList.SelectedIndex);
                }
                if (m_ItemAbilityReorderableList.SelectedIndex != -1) {
                    ShowAbility(false, m_ItemAbilityReorderableList.SelectedIndex);
                }
                if (m_EffectsReorderableList.SelectedIndex != -1) {
                    ShowEffect(m_EffectsReorderableList.SelectedIndex);
                }
            };
        ...
        {
            var foldout = new Foldout() { text = "Movement Types" };
        ...
        {
            var foldout = new Foldout() { text = "State Names" };
            container.Add(foldout);
        ...
        {
            var abilityFoldout = new Foldout() { text = addAbilities ? "Abilities" : "Item Abilities" };
        ...
        {
            var foldout = new Foldout() { text = "Effects" };
            foldout.contentContainer.AddToClassList("contained-list");
            container.Add(foldout);
        ...
        {
            var foldout = new Foldout() { text = "Events" };
            container.Add(foldout);
