...
namespace Opsive.UltimateCharacterController.Editor.Inspectors.Inventory
{
    ...
    public class InventoryInspector : InventoryBaseInspector
    {
        ...
        protected override void DrawInventoryProperties()
        {
            ...
            var startEquipSetting = PropertyFromName("m_AutoEquip");
            var optionsRect = GUILayoutUtility.GetRect(0, 18);
            var position = EditorGUI.PrefixLabel(optionsRect, new GUIContent("Auto Equip", startEquipSetting.tooltip));
            ...
            var value = (Inventory.AutoEquipSettings)ControlUtility.GetTargetObjectOfProperty(startEquipSetting);
            if (value.Option == Inventory.AutoEquipSettings.Options.ItemSetName) {
            ...
            } else if (value.Option == Inventory.AutoEquipSettings.Options.ItemSetIndex) {
