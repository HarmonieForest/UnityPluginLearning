...
namespace Opsive.UltimateCharacterController.Editor.Utility
{
    ...
    public class CharacterInputBuilder
    {
        ...
        public static void UpdateInputManager()
        {
            ...
            UnityInputBuilder.AddInputAxis(axisProperty, "Crouch", "", "joystick button 9", "", "c", 1000, 0.001f, 1000, false, false, UnityInputBuilder.AxisType.KeyMouseButton, UnityInputBuilder.AxisNumber.X);
            ...
            UnityInputBuilder.AddInputAxis(axisProperty, "Toggle Perspective", "", "joystick button 8", "", "v", 1000, 0.001f, 1000, false, false, UnityInputBuilder.AxisType.KeyMouseButton, UnityInputBuilder.AxisNumber.X);
            ...
            UnityInputBuilder.AddInputAxis(axisProperty, "Equip Next Item", "", "joystick button 3", "", "e", 1000, 0.001f, 1000, false, false, UnityInputBuilder.AxisType.KeyMouseButton, UnityInputBuilder.AxisNumber.X);
            ...
            UnityInputBuilder.AddInputAxis(axisProperty, "Reload", "", "joystick button 2", "", "r", 1000, 0.001f, 1000, false, false, UnityInputBuilder.AxisType.KeyMouseButton, UnityInputBuilder.AxisNumber.X);
            ...
            UnityInputBuilder.AddInputAxis(axisProperty, "Grenade", "", "joystick button 5", "", "g", 1000, 0.001f, 1000, false, false, UnityInputBuilder.AxisType.KeyMouseButton, UnityInputBuilder.AxisNumber.X);
            ...
            UnityInputBuilder.AddInputAxis(axisProperty, "SecondaryUse", "", "joystick button 4", "", "b", 1000, 0.001f, 1000, false, false, UnityInputBuilder.AxisType.KeyMouseButton, UnityInputBuilder.AxisNumber.X);
            ...
            UnityInputBuilder.AddInputAxis(axisProperty, "Action", "", "joystick button 1", "", "f", 1000, 0.001f, 1000, false, false, UnityInputBuilder.AxisType.KeyMouseButton, UnityInputBuilder.AxisNumber.X);
