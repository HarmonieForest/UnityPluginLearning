...
namespace Opsive.UltimateCharacterController.Inventory
{
    ...
    public class ItemSetGroup
    {
        ...
        public virtual void UpdateItemSets(List<CharacterItem>[] characterItemsBySlot)
        {
            ...
            var newActiveIndex =
                IsItemSetValid(temporaryAssignedActiveItemSet, false, -1) 
                    ? temporaryAssignedActiveItemSet : -1;
            var newNextIndex = 
                IsItemSetValid(temporaryAssignedNextItemSet, false, -1) 
                ? temporaryAssignedNextItemSet : -1;
            ...
            if (ActiveItemSetIndex == -1 && NextItemSetIndex == -1 && m_DefaultItemSetIndex != -1) {
                ...
                if (defaultItemSet?.IsValid ?? false) {
