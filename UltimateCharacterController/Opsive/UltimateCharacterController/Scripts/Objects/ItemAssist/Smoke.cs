...
namespace Opsive.UltimateCharacterController.Objects.ItemAssist
{
    ...
    public class Smoke : MonoBehaviour
    {
        ...
        public void Show(CharacterItem characterItem, int itemActionID, IPerspectiveProperty<Transform> perspectiveLocation, UltimateCharacterLocomotion characterLocomotion)
        {
        ...
        private void OnChangePerspectives(bool firstPersonPerspective)
        {
            ...
            //var itemAction = m_CharacterItem.ItemActions[m_ItemActionID];
            var smokeLocation = m_PerspectiveLocation.GetValue(firstPersonPerspective);
