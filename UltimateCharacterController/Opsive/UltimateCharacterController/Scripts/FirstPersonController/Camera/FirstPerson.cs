...
namespace Opsive.UltimateCharacterController.FirstPersonController.Camera.ViewTypes
{
    ...
    public abstract class FirstPerson : ViewType
    {
        ...
        protected Quaternion m_CharacterMovingPlatformRotationOffset = Quaternion.identity;
        ...
        public void InitializeSmoothHeadBuffer()
        {
            ...
            m_CharacterAnchorOffset = m_CharacterRigidbody.InverseTransformPoint(m_CharacterAnchor.position);
            m_SmoothHeadBufferEvent = null;
        }
        ...
        private void UpdateHeadOffset()
        {
            ...
            if (m_SmoothHeadBufferEvent == null && m_CharacterAnchor != null && m_SmoothHeadOffsetBuffer != null && m_SmoothHeadOffsetSteps > 0 && m_SmoothHeadBufferCount >= 0) {
                var offset = m_CharacterRigidbody.InverseTransformPoint(m_CharacterAnchor.position) - m_CharacterAnchorOffset;
        ...
        private Vector3 GetHeadOffset()
        {
            if (m_SmoothHeadBufferCount > 0) {
                ...
                return m_CharacterRigidbody.TransformDirection(total / m_SmoothHeadBufferCount);
            }
