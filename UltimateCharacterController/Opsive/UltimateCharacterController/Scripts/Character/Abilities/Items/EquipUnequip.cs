    ...
    public class EquipUnequip : ItemSetAbilityBase
    {
        ...
        public bool StartEquipUnequip(int itemSetIndex, bool forceEquipUnequip, bool immediateEquipUnequip)
        {
            ...
            if ((!IsActive && itemSetIndex == m_ItemSetManager.GetActiveItemSetIndex(m_ItemSetGroupIndex)) || 
                (IsActive && !immediateEquipUnequip && itemSetIndex == m_ItemSetManager.GetNextItemSetIndex(m_ItemSetGroupIndex))) {
                return false;
            }
        ...
        {
            if (register) {
                characterItem.OnAnimatorItemEquipE += m_OnAnimatorItemEquip;
                characterItem.OnAnimatorItemEquipCompleteE += m_OnAnimatorItemEquipComplete;
            } else {
                characterItem.OnAnimatorItemEquipE -= m_OnAnimatorItemEquip;
                characterItem.OnAnimatorItemEquipCompleteE -= m_OnAnimatorItemEquipComplete;
            }
        ...
        {
            if (register) {
                characterItem.OnAnimatorItemUnequipE += m_OnAnimatorItemUnequip;
                characterItem.OnAnimatorItemUnequipCompleteE += m_OnAnimatorItemUnequipComplete;
            } else {
                characterItem.OnAnimatorItemUnequipE -= m_OnAnimatorItemUnequip;
                characterItem.OnAnimatorItemUnequipCompleteE -= m_OnAnimatorItemUnequipComplete;
            }
