...
namespace Opsive.UltimateCharacterController.Character.Abilities
{
    ...
    public class AssistAim : Ability
    {
        ...
        public override void UpdateRotation()
        {
            ...
            var direction = Vector3.ProjectOnPlane(m_Target.TransformPoint(m_TargetOffset + (m_TargetPivotOffset != null ? m_TargetPivotOffset.Offset : Vector3.zero)) - m_Transform.TransformPoint(m_CenterOffset), m_CharacterLocomotion.Up);
            var rotation = m_Transform.rotation * m_CharacterLocomotion.DesiredRotation;
            var targetRotation = Quaternion.LookRotation(direction, rotation * Vector3.up);
