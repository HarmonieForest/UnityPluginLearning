...
namespace Opsive.UltimateCharacterController.Networking.Character
{
    ...
    public interface INetworkCharacter
    {
        ...
        void Fire(CharacterItemAction itemAction, float strength);

        /// <summary>
        /// Starts to reload the item.
        /// </summary>
        /// <param name="itemAction">The ItemAction that is being reloaded.</param>
        void StartItemReload(CharacterItemAction itemAction);
        ...
        void ReloadItem(CharacterItemAction itemAction, bool fullClip);
        ...
        void ItemReloadComplete(CharacterItemAction itemAction, bool success, bool immediateReload);
        ...
        void MeleeHitCollider(CharacterItemAction itemAction, int hitboxIndex, RaycastHit raycastHit, GameObject hitGameObject, UltimateCharacterLocomotion hitCharacterLocomotion);

        /// <summary>
        /// Throws the throwable object.
        /// </summary>
        /// <param name="itemAction">The ThrowableItem that is performing the throw.</param>
        void ThrowItem(CharacterItemAction itemAction);
        ...
        void EnableThrowableObjectMeshRenderers(CharacterItemAction itemAction);
        ...
        void StartStopBeginEndMagicActions(CharacterItemAction itemAction, bool beginActions, bool start);
        ...
        void MagicCast(CharacterItemAction itemAction, int index, uint castID, Vector3 direction, Vector3 targetPosition);
        ...
        void MagicImpact(CharacterItemAction itemAction, uint castID, GameObject source, GameObject target, Vector3 position, Vector3 normal);
        ...
        /// <param name="index">The index of the CastAction.</param>
        /// <param name="castID">The ID of the cast.</param>
        void StopMagicCast(CharacterItemAction itemAction, int index, uint castID);
        ...
        void ToggleFlashlight(CharacterItemAction itemAction, bool active);
