...
namespace Opsive.UltimateCharacterController.ThirdPersonController.Items
{
    ...
    public class ThirdPersonPerspectiveItem : PerspectiveItem
    {
        ...
        [SerializeField] protected IDObject<Transform> m_NonDominantHandIKTarget;
        [Tooltip("The location of the non-dominant hand hint which should be placed by the IK implementation.")]
        [SerializeField] protected IDObject<Transform> m_NonDominantHandIKTargetHint;
        ...
        [NonSerialized] public IDObject<Transform> NonDominantHandIKTargetIDObject { get { return m_NonDominantHandIKTarget; } set { m_NonDominantHandIKTarget = value; } }
        [NonSerialized] public IDObject<Transform> NonDominantHandIKTargetHintIDObject { get { return m_NonDominantHandIKTargetHint; } set { m_NonDominantHandIKTargetHint = value; } }
        [NonSerialized] public IDObject<Transform> HolsterTargetIDObject { get { return m_HolsterTarget; } set { m_HolsterTarget = value; } }
        
        [NonSerialized] public Transform NonDominantHandIKTarget { get { return m_NonDominantHandIKTarget.GetObject(m_CharacterModel, true); } set { m_NonDominantHandIKTarget.Obj = value; } }
        [NonSerialized] public Transform NonDominantHandIKTargetHint { get { return m_NonDominantHandIKTargetHint.GetObject(m_CharacterModel, true); } set { m_NonDominantHandIKTargetHint.Obj = value; } }
        ...
        public override void OnCharacterSwitchModels(GameObject activeModel)
        {
            ...
            m_NonDominantHandIKTarget.ResetValue();
            m_NonDominantHandIKTargetHint.ResetValue();
