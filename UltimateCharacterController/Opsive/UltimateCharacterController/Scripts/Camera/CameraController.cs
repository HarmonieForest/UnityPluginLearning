...
namespace Opsive.UltimateCharacterController.Camera
{
    ...
    public class CameraController : StateBehavior, ILookSource, Shared.Camera.ICamera
    {
        ...
        public void SetViewType(System.Type type, bool immediateTransition)
        {
            ...
            if (originalViewType != null && m_Character != null && Application.isPlaying) {
                ...
                if (!immediateTransition && m_Transitioner != null) {
                    ...
                    if (m_ActiveViewType.RotatePriority) {
        ...
        {
            SimulationManager.RegisterCamera(this);
        }
        ...
        private void InitializeCharacter(GameObject character)
        {
            ...
            if (m_Character != null) {
                m_ActiveViewType.ChangeViewType(true, 0, 0, m_CharacterTransform.rotation);
        ...
        private void InitializeAnchor()
        {
            ...
            if (m_AutoAnchor) {
                ...
                if (modelManager != null) {
                    ...
                    var animatorMonitor = m_Character.GetComponentInChildren<AnimatorMonitor>();
        ...
        public void Rotate(float horizontalMovement, float verticalMovement)
        {
            ...
            } else if (m_ActiveViewType.RotatePriority) {
        ...
        public void Move(float horizontalMovement, float verticalMovement)
        {
            ...
            if (m_ActiveViewType.RotatePriority) {
                ...
                m_Transform.SetPositionAndRotation(m_ActiveViewType.Move(false), m_ActiveViewType.Rotate(horizontalMovement, verticalMovement, false));
            }
        }
        ...
        {
            if (m_CharacterLocomotion.TimeScale == 0 || (m_Transitioner != null && m_Transitioner.IsTransitioning)) {
                return;
            }

            m_ActiveViewType.LateUpdate();
        }
        ...
        {
            SimulationManager.UnregisterCamera(this);
        }
