...
namespace Opsive.UltimateCharacterController.Items.Actions.Modules.Throwable
{
    ...
    /// </summary>
    [Serializable]
    public class ItemAmmo : ThrowableAmmoModule,
        IModuleCanStartUseItem
    {
        ...
        protected virtual void OnAdjustItemIdentifierAmount(IItemIdentifier itemIdentifier, int previousAmount,
            int newAmount)
        {
            NotifyAmmoChange();
        }
