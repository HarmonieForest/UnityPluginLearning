...
namespace Opsive.UltimateCharacterController.Items.Actions.Modules.Shootable
{
    ...
    public abstract class ShootableAmmoModule : ShootableActionModule
    {
        ...
        public abstract void LoadAmmoIntoList(List<ShootableAmmoData> clipRemaining, int reloadAmount,
        ...
        {
            Shared.Events.EventHandler.ExecuteEvent<CharacterItem, ShootableAmmoModule>(Character,
                "OnShootableItemAmmoChange", CharacterItem, this);
        }
        ...
        {
            var ammoData = new ShootableAmmoData(this,
                -1,-1,null,null);
            return ammoData;
        }
    }
    ...
    public class ItemAmmo : ShootableAmmoModule, IModuleGetItemsToDrop
    {
        ...
        public ItemDefinitionBase AmmoItemDefinition { get { return m_AmmoItemDefinition; } set { m_AmmoItemDefinition = value; } }
        ...
        public override bool DoesAmmoSharedMatch(ShootableAmmoModule otherAmmoModule)
        {
            if (m_SharedAmmoItemIdentifier == false || otherAmmoModule.IsAmmoShared() == false) {
                return false;
            }
