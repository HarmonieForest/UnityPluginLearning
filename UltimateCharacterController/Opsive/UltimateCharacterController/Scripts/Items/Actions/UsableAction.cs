...
namespace Opsive.UltimateCharacterController.Items.Actions
{
    ...
    public class UsableAction : CharacterItemAction, IUsableItem, IDamageSource
    {
        ...
        /// <summary>
        /// On Aim is usually called by the Aimer module such that other modules can listen to it.
        /// </summary>
        ...
        public void OnAim(bool aim, bool inputStart)
        {
            ...
            InvokeOnModulesWithType(aim, inputStart,
                (IModuleOnAim module, bool i1, bool i2)=> module.OnAim(i1,i2));
        }

        /// <summary>
        /// Can the item be used?
        /// </summary>
        /// <param name="useAbility"></param>
        ...
        public virtual bool CanStartUseItem(Use useAbility, UseAbilityState abilityState)
        {
            ...
            var (modulesCanStart, moduleThatStopped) = InvokeOnModulesWithTypeConditional(useAbility, abilityState,
                (IModuleCanStartUseItem module, Use i1, UseAbilityState i2) =>
                    module.CanStartUseItem(i1, i2), false);
        ...
        public virtual void UseItemAbilityStarted(Use useAbility)
        {
            ...
            InvokeOnModulesWithType(useAbility,
                (IModuleUseItemAbilityStarted module, Use i1) => module.UseItemAbilityStarted(i1));
        ...
        public virtual void ItemUseComplete()
        {
            ...
            if (m_StopUseAbilityOnCompleteDelay < 0) {
                ...
                ResetCanStopEvent();
                m_CanStopEvent =
                    SchedulerBase.ScheduleFixed(m_StopUseAbilityOnCompleteDelay, SetCanStopAbility, true);
            }
        ...
        public bool TryStopItemUse()
        {
            ...
            if (CanStopItemUse() == false) {
                return false;
            }

            if (m_UseCompleted == false) {
        ...
        public virtual bool CanStopItemUse()
        {
            ...
            if (modulesCanStopItemUse == false) {
