...
namespace Opsive.UltimateCharacterController.Items.Actions
{
    ...
    public class ShootableAction : UsableAction, IReloadableItem
    {
        ...
        {
            // Here I override the Use Item, the base.UseItem is called from within the TriggerFire function.
        ...
        /// <summary>
        /// Can reload camera zoom?
        /// </summary>
        /// <returns>True if the reload camera can zoom.</returns>
        public virtual bool CanReloadCameraZoom()
        {
            if (ReloadableItemModule == null) {
                return true;
            }

            return ReloadableItemModule.CanReloadCameraZoom();
        }
