...
namespace Opsive.UltimateCharacterController.Items
{
    ...
    {
        public Action<int> OnAnimatorItemEquipE;
        public Action<int> OnAnimatorItemEquipCompleteE;
        public Action<int> OnAnimatorItemUnequipE;
        public Action<int> OnAnimatorItemUnequipCompleteE;
        ...
        {
            OnAnimatorItemEquipE?.Invoke(m_SlotID);
        }
        ...
        {
            OnAnimatorItemEquipCompleteE?.Invoke(m_SlotID);
        }
        ...
        {
            OnAnimatorItemUnequipE?.Invoke(m_SlotID);
        }
        ...
        {
            OnAnimatorItemUnequipCompleteE?.Invoke(m_SlotID);
        }
